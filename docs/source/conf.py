...
import EnergyExtraction  # noqa



# -- Project information -----------------------------------------------------

project = "EnergyExtraction"
copyright = (
    "2026, Ricardo Ramirez. "
...
htmlhelp_basename = "EnergyExtractiondoc"
...
latex_documents = [
    (master_doc, "EnergyExtraction.tex", "EnergyExtraction Documentation",
     "EnergyExtraction", "manual"),
]
...
man_pages = [
    (master_doc, "EnergyExtraction", "EnergyExtraction Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "EnergyExtraction", "EnergyExtraction Documentation",
     author, "EnergyExtraction", "Code developed to extract parwise and per residue energies from MD simulations",
     "Miscellaneous"),
]
